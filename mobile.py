...
for i in slices:
    ...
    torch.save(model.state_dict(), "EAF-SR.pt")
# #
model = SASRec(n_node, blocks)
test_data = pickle.load(open('../datasets/' + dataset + '/test.txt', 'rb'))
test_data = Data(test_data, shuffle=False)
slices = test_data.generate_batch(100)
checkpoint = torch.load("EAF-SR.pt", map_location=torch.device('cpu'))
model.eval()
...
traced_encoder_optimized._save_for_lite_interpreter(r"/home/taiheng/Python_document/EAF-SR/EAF-SR.ptl")
#
